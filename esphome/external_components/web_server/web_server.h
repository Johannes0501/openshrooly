...
extern const uint8_t ESPHOME_WEBSERVER_APP_HTML_INCLUDE[] PROGMEM;
extern const size_t ESPHOME_WEBSERVER_APP_HTML_INCLUDE_SIZE;
#endif
...
class WebServer : public Controller, public Component, public AsyncWebHandler {
 ...
 public:
  ...
  /// Handle static file requests from filesystem
  void handle_static_file_request(AsyncWebServerRequest *request);
 ...
 protected:
  ...
  std::string get_content_type_(const std::string &path);
